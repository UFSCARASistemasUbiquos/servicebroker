 ...
 * @author THIAGO
 */
public class DlnaServiceBrockerServer extends Thread {

    public void DlnaServiceBrockerServer() {
...
LocalDevice createDevice()
    ...
    LocalService<ServiceBrockerService> serviceBrockerService =
            new AnnotationLocalServiceBinder().read(ServiceBrockerService.class);

    serviceBrockerService.setManager(
            new DefaultServiceManager(serviceBrockerService, ServiceBrockerService.class)
    );

    //return new LocalDevice(identity, type, details, icon, serviceBrockerService);
    return new LocalDevice(identity, type, details, serviceBrockerService);
